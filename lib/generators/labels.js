...
var DB_TABLE_LANGUAGES = Resource.DB_TABLE_LANGUAGES = "sites_multilingual_languages"
...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        ...
        description:[ 
            'This command creates a multilingual label in the appdev site_multilingual_label table.',
            '',
