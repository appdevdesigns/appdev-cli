...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        commandFormat:'appdev labelImport <green>[dir:[path/to/dir]] [format:[type]] [file:[path/to/file]]</green>',
        description:[ 
        ...
        parameters:[
            ...
            '<green>[file:[type]]</green>          :   <green>(optional)</green> choose an individual file to import ',
        ],
