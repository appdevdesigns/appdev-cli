...
Resource.patchFiles = function(done) {
    ...
    var modelData = fc.readFileSync(path.join('api', 'models', this.templateData.ModelName + '.js'), {encoding:'utf8'});
    ...
    var controllerData = fc.readFileSync(path.join('api', 'controllers', this.templateData.ModelName + 'Controller.js'), {encoding:'utf8'});
