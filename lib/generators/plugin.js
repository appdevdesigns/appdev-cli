...
Module.installDependencies = function(done) {
    ...
    var listDependencies = [
        ...
        { command:'npm', options:[ 'install',  'phantomjs', '--save-dev'], textFilter:textFilters, log:'<green><bold>installing:</bold> phantomjs (dev: unit testing client)</green>', shouldEcho:false },

        // > npm install mocha-phantomjs --save-dev
        { command:'npm', options:[ 'install',  'mocha-phantomjs', '--save-dev'], textFilter:textFilters, log:'<green><bold>installing:</bold> mocha-phantomjs (dev: unit testing client)</green>', shouldEcho:false },
