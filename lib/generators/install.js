...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        commandFormat:'appdev install <yellow><bold>[dir_name]</bold></yellow> <green>[plugins:moduleA,moduleB] [--develop] [--travisCI]</green>',
        description:[ 
        ...
        parameters:[
            ...
            '<green>[plugins]</green>          :   <green>(optionsl)</green> specify the plugins to install.',
...
Resource.installLibraries = function(done) {
    ...
    if (!this.params.noDependencies) {
        ...
        if (this.options.modules) {
            ...
            // just to enable laziness: make sure appdev-opsportal is included 
            // by default:
            var hasOpsportal = false;
            modules.forEach(function(module) {
                if (module.indexOf('appdev-opsportal') != -1) {
                    hasOpsportal = true;
                }
            })
            if (!hasOpsportal) {
