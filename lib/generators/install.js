...
// AD.log('<green><bold>****** --develop mode ******</bold></green>');
        ...
        listInstall.push({ command:'npm', options:[ 'install',  'steal-tools@0.13.3', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  stealjs as a dependency', retry:3 });
