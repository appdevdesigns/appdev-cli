...
//            { command:'git', options:[ 'clone',  'https://github.com/appdevdesigns/appdev-client.git', path.join('assets', 'appdev')], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  appdev client side library', retry:3 },
        ...
        listInstall.push({ command:'npm', options:[ 'install',  'appdevdesigns/appdev-core#v10', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  appdev-core as a dependency', retry:3 });
        ...
        listInstall.push({ command:'npm', options:[ 'install',  'appdevdesigns/ad-utils#v10', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  ad-utils as a dependency', retry:3 });
    }
