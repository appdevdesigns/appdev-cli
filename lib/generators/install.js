...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        commandFormat:'appdev install <yellow><bold>[dir_name]</bold></yellow> <green>[plugins:moduleA,moduleB] [--develop] [--travisCI] [--docker]</green>',
        description:[ 
...
Resource.installAdditionalPlugins = function(done) {
    ...
    if (!this.params.noDependencies) {
        ...
        if (this.options.plugins) {
            ...
            this.options.plugins.forEach(function(module){
