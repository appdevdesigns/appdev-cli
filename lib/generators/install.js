...
// Eventually we simply want to do this:
/*
...
// npm install sails-mysql@0.10.x
                ...
                self.shell('git', params, ['Creating'], function(){
                    ...
                    if (!fs.existsSync(sailsPath)) {
                        ...
                        var mergeParams = ['merge', 'git@github.com:......'];
...
//    var self = this;
    ...
    util.log('<yellow><bold> *** disabling Grunt File: </bold></yellow>');

    var params = [ 'Gruntfile.js',  'Gruntfile_disable.js'];

    this.shell('mv', params, [], function(){
