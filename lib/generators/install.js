...
// AD.log('<green><bold>****** --develop mode ******</bold></green>');
        ...
        listInstall.push({ command:'npm', options:[ 'install',  'can@~2.3.15', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  canjs as a dependency', retry:3 });

        // install StealJS :  our client side apps : 
        listInstall.push({ command:'npm', options:[ 'install',  'steal@~0.13.2', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  stealjs as a dependency', retry:3 });

        // install StealJS tool : 
        listInstall.push({ command:'npm', options:[ 'install',  'steal-tools@~0.13.3', '--save'], textFilter:textFilters, log:'<yellow><bold>install:</bold></yellow>  steal-tools as a dependency', retry:3 });
