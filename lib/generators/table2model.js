...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        commandFormat:'appdev table2model <yellow><bold>[application] [table] [modelName] [db:[dbname]]</bold></yellow>',
        description:[ 
            'This command creates a new Model definition from an existing table in the database.',
            '',
            'If the table is in a database other than the site default, add db:[dbname] to the command.'
        ...
        parameters:[
            ...
            '<yellow>[db:[dbname]]</yellow>         :   (optional) the name of the db to read from'
        ],
