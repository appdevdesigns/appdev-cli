...
//            this.processMysql();
        ...
        default:
            ...
            util.log();
            util.log('<yellow>make sure the adapter:"xxx" setting in your .adn file is correct.</yellow>');
            util.log();
            util.log('<yellow><bold>eg:</bold></yellow><green>appdev default adapter mysql</green>');
            util.log();
            process.exit(1);
    }
