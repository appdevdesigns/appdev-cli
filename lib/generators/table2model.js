...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        ...
        parameters:[
            ...
            '<green>[connection:[name]]</green>   :   <green>(optional)</green> the name of the adapter connection to use (default:\'mysql\')'
        ],
...
//    var self = this;
    ...
    if (this.config) {
        ...
        var adapterType = '???';
        var module = this.config.adapter  || 'no module defined';
