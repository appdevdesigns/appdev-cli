...
//console.log(config);
    ...
    switch(config.layout) {
        ...
        case 'crudlist':
            ...
            this.templateData.router.models.push(config.model);
...
//console.log('modelName['+modelName+']');
            ...
            this.templateData.router.setup = [{
                    model: {
                    ...
                    divID:'list',
                    view_add:'pages/'+this.templateData.pageName+'/'+modelName+'_add.ejs'
            }];
            break;
