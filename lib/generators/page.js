...
Resource.prepareTemplateData = function () {
    ...
    this.templateData.useLayout = 'layout:false';       // by default, no layout.
...
////patch config/local.js to include the local mysql settings
    var patchSet = [ {  file:pathToController, tag:"};", template:'__page_pagecontroller_method.ejs', data:{pageName:this.options.pageName, useLayout:this.templateData.useLayout} },
