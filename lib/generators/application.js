...
Resource.help = function() {
    ...
    this.showMoreHelp(    {
        ...
        examples:[
            ...
            '    // '+path.join('assets', 'newSailsApp', 'setup.js')+'    : initial file for loading the app',
            '',
            '> appdev install someDir/newSailsApp',
...
//    });
    AD.spawn.command({
        command:'appdev',
        options:[ 'cui',  this.templateData.name, this.templateData.defaultController],
